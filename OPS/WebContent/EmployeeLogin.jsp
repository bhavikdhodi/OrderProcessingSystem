    ...
    <body background="Background.png">
        ...
        <div class="container-fluid">
            <center>
                ...
                <div margin:top="3cm">
                    <table style="color:#ffffff; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif, Helvetica, cursive; padding-inline-start:1cm; padding-inline-end: ;">
                            ...
                            <tr style="margin-top:1cm;">
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <button style=" margin-top: 1 cm; background-color: white; color: #ef241c; border: 2px solid #ef241c; border-radius: 8px;" type="submit" class="btn btn-primary"> Submit </button></th>
                                </tr>
                        </form>
                    </table>
                    </div>
            ...
            String str1=(String) request.getAttribute("errormsg");
                if(str1!=null)
                {%>
                        <h3 style="margin-top: 2cm; color:#ffffff">
                            <%out.print(str1);
                }
                %>
                                ...
                                <h3>
                                    <marquee style="margin-top:1cm; color:#ffffff;">Notice:</marquee>
                                </h3>
                </div>
            </center>
        </div>
